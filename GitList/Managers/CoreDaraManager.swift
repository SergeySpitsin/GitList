...
/// Manager for CoreData with store "GitList".
class CoreDataManager {
    ...
    /// A container that encapsulates the Core Data **GitList** in application.
    public lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "GitList")
    ...
    /// Attempts to commit unsaved changes to store.
    ...
    /// Get description of an entity in Core Data by entity name.
    ///
